...
qgis_path = '/opt/homebrew/Caskroom/miniforge/base/envs/qgis/lib/'
...
def tif_create():
    ...
    for i in track(range(len(list_gpkgs)), description="Processing..."):

        # name of geopackage file
        gpkg_name = list_gpkgs[i]
        ...
        try:
            ...
            tmp_clip = clip_spatial(gpkg_name, processing)
...
def clip_spatial(gpkg_name, processing):
