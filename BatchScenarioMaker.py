...
# split the scenarios
very_low_scenarios = [file for file in scenario_files if '_very_low_' in file]
low_scenarios = [file for file in scenario_files if '_low_' in file and '_very_' not in file]
medium_scenarios = [file for file in scenario_files if '_medium_' in file]
high_scenarios = [file for file in scenario_files if '_high_' in file]
ultra_scenarios = [file for file in scenario_files if '_ultra_' in file]
