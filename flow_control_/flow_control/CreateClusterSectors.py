...
conflog_file = open("CONFLOG_Flight_intention_low_40_8_noflow.log", "r")
...
print(len(conflog_list))
points=np.array(conflog_list)   #test with small aray instead of fixed array
...
# plt.show()
output_file=open("Flow_control_clusters_centers6.dill", 'wb')
