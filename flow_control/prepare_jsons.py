...
# after --json is directory where JSONS should be saved
# after --graphml is the path to the graphml file inside whole_vienna/gis
...
with open('airspace_design/open_airspace_final.dill', 'rb') as f:
...
with open(f'{json_path}/stroke_length.json', 'w') as fp:
...
# save node dictionary to JSON
with open(f'{json_path}/flow_length.json', 'w') as fp:
...
with open(f'{json_path}/constrained_node_dict.json', 'w') as fp:
...
# save node dictionary to JSON
with open(f'{json_path}/nodes.json', 'w') as fp:
...
with open(f'{json_path}/const_edges.json', 'w') as fp:
...
with open(f'{json_path}/edges.json', 'w') as fp:
    json.dump(edge_dict_new, fp, indent=4)
...
# save edge dictionary as json
with open(f'{json_path}/strokes.json', 'w') as fp:
...
# save edge dictionary as json
with open(f'{json_path}/flows.json', 'w') as fp:
...
with open(f'{json_path}/dummy.json', 'w') as fp:
