...
constrained_airspace = gpd.read_file('airspace_design/offset_border_polygon.gpkg').to_crs(epsg=4326)
...
output_file=open(f"airspace_design/constrained_poly_buffered.dill", 'wb')
